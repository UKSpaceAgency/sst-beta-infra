...
module "space_track_satellites_ingestion_finished" {
  ...
  cluster_log_group_name = var.cluster_log_group_name
  env_name               = var.env_name
  alarm_name             = "No ingestion of Satellites from Space-Track has been completed in last 6.5 hours"
  alarm_description      = "No ingestion of Satellites from Space-Track has been completed in last 6.5 hours"
